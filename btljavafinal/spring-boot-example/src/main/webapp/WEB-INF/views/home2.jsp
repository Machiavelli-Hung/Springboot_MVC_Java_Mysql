    ...
    <head>
        ...
        <style>
            * {
            ...
            .auth-buttons {
                float: right;
                margin-right: 1rem; /* Thêm khoảng cách từ cạnh phải */
                margin-top: -1.6rem; /* Căn chỉnh từ phía trên */
            }
            ...
            .btn {
                ...
                text-decoration: none;
                margin-left: 1rem;
                display: inline-block; /* Đảm bảo các nút nằm ngang */
                position: relative; /* Bỏ phần margin-top âm */
                font-size: 0.8rem; /* Tăng kích thước chữ (có thể điều chỉnh) */
                font-weight: bold;
            }
            .list_stadium {
                display: flex;
            ...
            .sidebar td {
                ...
                font-size: 1rem;
                color: #333;
                border-top: 1px solid #ddd; /* Đường kẻ giữa các hàng */
            }
            ...
            .venues-grid {
                ...
                gap: 1rem;
                flex: 3;
                margin-top: 4rem; /* Điều chỉnh thêm khoảng cách nếu cần */
